...
class model{
    ...
    public function add_hotel($titulo, $nombre_hotel, $direccion, $cant_personas, $cant_habitaciones, $in, $out, $id_viaje = null, $descripcion = null, $tipo_habitaciones = null, $servicios_hotel = null){
        ...
        if($id_viaje == null){
            ...
            if(count($id) == 1 && $id["id_viaje"]!=null && isset($id["id_viaje"])){
        ...
        echo "<br>Segundo insert hecho";
        //TESTING --- Devuelvo lastInsertId para revisar que se cargue correctamente y testear model.getHotel(id_plan).
        return $id_plan;
    }
